...
ADAPTER_PATH="${ADAPTER_PATH:-${PROJECT_DIR}/data/output/kgqa/ch4_pfit/webqsp/transfernet_v2/主实验/seed_17/adapter}"
...
LLM_SERVER_BATCH_WAIT_MS="${LLM_SERVER_BATCH_WAIT_MS:-0}"

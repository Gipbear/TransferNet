...
OUTPUT_JSONL="${OUTPUT_JSONL:-${PROJECT_DIR}/data/output/WebQSP/path_retrieve_server/paths/mmr_beam50_alpha1_lam0.5.jsonl}"
BERT_NAME="${BERT_NAME:-BAAI/bge-base-en-v1.5}"

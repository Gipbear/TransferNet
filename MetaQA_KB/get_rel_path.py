...
args = []
with open("data/output/MetaQA/predict_result_with_path_info_train.jsonl") as f:
...
with open("data/output/MetaQA/predict_result_with_truth_path_train.jsonl", 'w') as f:
    for info in truth_paths_data:
        f.write(json.dumps(info) + '\n')
print("Saved to data/output/MetaQA/predict_result_with_truth_path_train.jsonl")
